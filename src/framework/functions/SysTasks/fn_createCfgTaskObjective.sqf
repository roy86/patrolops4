...
if (_taskLogic isEqualType "") then { _taskLogic = missionNamespace getVariable [_taskLogic,objNull]; };
...
private _title = _taskLogic getVariable ["taskTitle",(["TaskDetails",[_cfgTaskID,"title"]] call MPSF_fnc_getCfgTasks)];
private _description = _taskLogic getVariable ["taskDesc",(["TaskDetails",[_cfgTaskID,"description"]] call MPSF_fnc_getCfgTasks)];
...
if (_taskPos isEqualType "") then { _taskPos = _taskPos call BIS_fnc_position; };
