...
// Task Data
	...
	case "childTasks" : {
		...
		private _childTaskIDs = if (_mode isEqualTo "childTasks") then {["CfgMissionTasks",_taskID,"ChildTasks"] call BIS_fnc_getCfgSubClasses} else {[]};
		_childTaskIDs append (["CfgMissionTasks",_taskID,"ChildTasks",_dataType] call BIS_fnc_getCfgDataArray);
