...
if (_className isEqualTo "") exitWith {
	/* ["Invalid %1",_this] call BIS_fnc_error; */
	[objNull,[],[]]
};
...
if (isNull _vehicle) exitWith {
	/* ["MissionBuilder Failed to create vehicle %1 in spawnVehicle",_className] call BIS_fnc_error; */
	[objNull,[],[]]
};
...
if (_spawnCargo) then {
	...
	_spawnpos set [2,0];
	private _spawnGroup = [_spawnpos,_faction,_cargoUnits] call MPSF_fnc_createGroup;
