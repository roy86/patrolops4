...
// Configuration
	case "getCfgStartPoints" : {
		...
		["CfgMissionConversations",_conversationID,"startPoints"] call MPSF_fnc_getCfgDataArray;
	};
	case "getCfgResumePoints" : {
		_params params [["_conversationID","",[""]]];
		["CfgMissionConversations",_conversationID,"resumePoints"] call MPSF_fnc_getCfgDataArray;
	};
	case "getCfgResponse" : {
		_params params [["_conversationID","",[""]],["_conversationSegmentID","",[""]]];
		[
			_conversationSegmentID
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"displayText"] call MPSF_fnc_getCfgDataText
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"condition"] call MPSF_fnc_getCfgDataText
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"options"] call MPSF_fnc_getCfgDataArray
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"arguments"] call MPSF_fnc_getCfgDataArray
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"action"] call MPSF_fnc_getCfgDataArray
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"endConversation"] call MPSF_fnc_getCfgDataBool
		]
	};
	case "getCfgResponseActions" : {
		_params params [["_conversationID","",[""]],["_conversationSegmentID","",[""]],["_resolve",false,[false]]];
		private _actions = ["CfgMissionConversations",_conversationID,_conversationSegmentID,"options"] call MPSF_fnc_getCfgDataArray;
		if (_resolve) then {
	...
	case "getCfgActions" : {
		_params params [["_conversationID","",[""]],["_conversationSegmentID","",[""]],["_resolve",false,[false]]];
		private _actions = ["CfgMissionConversations",_conversationID,_conversationSegmentID,"actions"] call MPSF_fnc_getCfgDataArray;
		if (_resolve) then {
			_actions = _actions apply { ["getCfgAction",[_conversationID,_x]] call MPSF_fnc_conversation; };
		};
		_actions
	...
	case "getCfgAction" : {
		...
		[
			...
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"displayText"] call MPSF_fnc_getCfgDataText
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"condition"] call MPSF_fnc_getCfgDataText
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"responses"] call MPSF_fnc_getCfgDataArray
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"effect"] call MPSF_fnc_getCfgDataArray
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"action"] call MPSF_fnc_getCfgDataText
			,["CfgMissionConversations",_conversationID,_conversationSegmentID,"endConversation"] call MPSF_fnc_getCfgDataBool
		]
	};
	...
	case "getCfgResponseCode" : {
		_params params [["_conversationID","",[""]],["_conversationSegmentID","",[""]],["_resolve",false,[false]]];
		["CfgMissionConversations",_conversationID,_conversationSegmentID,"code"] call MPSF_fnc_getCfgDataText;
	};
	case "getCfgResponseFunction" : {
		_params params [["_conversationID","",[""]],["_conversationSegmentID","",[""]],["_resolve",false,[false]]];
		["CfgMissionConversations",_conversationID,_conversationSegmentID,"function"] call MPSF_fnc_getCfgDataText;
	};
	case "getCfgResponseRemove" : {
		_params params [["_conversationID","",[""]],["_conversationSegmentID","",[""]]];
		["CfgMissionConversations",_conversationID,_conversationSegmentID,"removeAction"] call MPSF_fnc_getCfgDataBool;
	};
...
// Actions
	case "addAction" : {
		...
		[
			...
			,_NPC
			,format["<img image='\a3\ui_f\data\gui\cfg\CommunicationMenu\supplydrop_ca.paa' /> Speak With %1",if (_NPCname isEqualTo "") then {"Civilian"} else {_NPCname}] // TODO: localize
