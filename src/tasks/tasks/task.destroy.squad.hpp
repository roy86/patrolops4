...
class Task_Destroy_Squad {
	...
	class TaskDetails {
		...
		description[] = {
			...
			,"<t size='1.1' color='#FFC600'>Brief:</t> <t>INTEL report identifies a small %7 squad was observed near %5 and appears to pose an immediate threat to the AO and must be dealt with.</t>"
