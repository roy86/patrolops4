...
class Task_Destroy_FuelDepot {
	...
	class TaskDetails {
		title = "Destroy Fuel Supply";
		description[] = {
			"<t>Ref: %1</t> | <t>Date: %2<br/>AO: %3 %4 near %5</t>"
			,"<t size='1.1' color='#FFC600'>Brief:</t> <t>Intel places a small %7 refueling position near %5 and is an ideal opportunity to damage supply lines for %7 forces and their movements.</t>"
			,"<t size='1.1' color='#FFC600'>Action:</t> <t>%6 forces will move to the area to conduct a sweep in order to locate and elimiate the %7 forces before retieving any intel from technological assets.</t>"
	...
	class Compositions {
		class CommsTent {
			...
			targets[] = {"StorageBladder_02_water_forest_F","StorageBladder_01_fuel_sand_F"};
		};
	};
