...
*/
class Task_Download_intel_camp {
	scope = 1;
	target = -1;
	typeID = 10;
	...
	positionSearchTypes[] = {"Clearing","Hill","SportField"};
	positionIsWater = 0;
	...
	class TaskDetails {
		...
		description[] = {
			...
			,"<t size='1.1' color='#FFC600'>Brief:</t> <t>A small %7 camp was observed near %5 and is an ideal opportunity to gain intel on %7 forces and their movements.</t>"
			,"<t size='1.1' color='#FFC600'>Action:</t> <t>%6 forces will move to the area to conduct a sweep in order to locate and elimiate %7 forces before retieving any intel from technological assets.</t>"
	...
	class Compositions {
		class CommsTent {
			...
			typeIDs[] = {"en_camp_3_intel","en_camp_4_intel","en_camp_5_intel"};
			downloadIntel = 1;
		};
	};
