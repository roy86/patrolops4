...
class Task_Destroy_HVT {
	...
	class TaskDetails {
		...
		description[] = {
			...
			,"<t size='1.1' color='#FFC600'>Brief:</t> <t>INTEL points to a %7 target of opportunity observed near %5 and is a known high value target that %6 command would like removed from the battlefield.</t>"
			,"<t size='1.1' color='#FFC600'>Action:</t> <t>%6 forces will move to the area to conduct a sweep in order to locate and capture the %7 HVT if possible. Bag any bodies of targets left behind.</t>"
