...
class Task_Destroy_Cache {
	...
	class TaskDetails {
		title = "Destroy Lethal Aid";
		description[] = {
			"<t>Ref: %1</t> | <t>Date: %2<br/>AO: %3 %4 near %5</t>"
			,"<t size='1.1' color='#FFC600'>Brief:</t> <t>INTEL identifies a small %7 squad was observed near %5 moving what is beleived to be leathal aid into the AO and must be dealt with.</t>"
	...
	class Groups {
		class weaponsCache_1 {
			probability = 1;
			isTarget = 1;
			objectTypes[] = {"Box_FIA_Ammo_F","Box_FIA_Support_F","Box_FIA_Wps_F","Box_Syndicate_Ammo_F","Box_Syndicate_WpsLaunch_F"};
